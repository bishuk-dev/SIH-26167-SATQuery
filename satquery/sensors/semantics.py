...
SENSOR_BAND_MAPPINGS: dict[str, dict[SemanticBandRole, tuple[str, ...]]] = {
    ...
    "generic": {
        SemanticBandRole.RED: ("red", "band4", "r"),
        SemanticBandRole.GREEN: ("green", "band3", "g"),
        SemanticBandRole.BLUE: ("blue", "band2", "b"),
        SemanticBandRole.NIR: ("nir", "band8", "b8a", "near_infrared"),
        SemanticBandRole.SWIR: ("swir", "swir1", "swir2", "band11", "band12"),
        SemanticBandRole.SWIR1: ("swir1", "band11"),
        SemanticBandRole.SWIR2: ("swir2", "band12"),
        SemanticBandRole.RED_EDGE: ("red_edge", "rededge", "re"),
