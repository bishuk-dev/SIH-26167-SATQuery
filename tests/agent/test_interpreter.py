...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("What is the sensor model?", "METADATA_QUERY", None, None, None, False, "metadata_question"),
        ...
        ("Where did water loss occur?", "CHANGE_LOCALIZE", "water", None, "T2_TO_T1", True, "water_change_localization"),
